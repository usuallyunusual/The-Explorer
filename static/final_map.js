...
(function()
{
    ...
    // Initialize process.
    //
    // After page loading, get month of today.
    var listCount = $("#test-list li").length;
    var monthOfToday = new Date().getMonth() + 1;
    // This variable will be incremented  or decremented or reseted _
    // when clicking the buttons(prev, today, next).
